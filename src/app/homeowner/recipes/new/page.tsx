  ...
  return (
    <div className={styles.narrowPage}>
      ...
      <header className={styles.pageHeader}>
        ...
        <h1>Add a recipe</h1>
        <p>Paste one public recipe webpage. The source remains attached to the draft and nothing is publishable until you review it.</p>
      </header>
      <ImportForm />
      <section className={styles.manualCallout}>
        <div><p className={styles.eyebrow}>Reliable fallback</p><h2>Already know the recipe?</h2><p>Enter the ingredients and steps manually when a webpage is unsupported.</p></div>
