...
Milestones 1 and 2, English-first automatic Hindi, and the requested househelp cooking-menu/one-time-language repair are integrated and verified locally on `main`.
...
Select a compatible public hosting target, persistent datastore, and production identity approach. Real-device househelp sessions remain required before production launch.
