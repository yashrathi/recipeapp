...
- The househelp cooking menu contains active, pinned, bilingual assignments only—not the homeowner recipe library. It presents one dish at a time, excludes server-completed work, and also hides a locally completed assignment while its offline completion is waiting to sync.
